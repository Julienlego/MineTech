...
public class GenericHoe extends GenericItemTool{
	
	protected static MTEnumToolMaterial toolMaterial;
	
	public GenericHoe(int i, MTEnumToolMaterial enumtoolmaterial){
