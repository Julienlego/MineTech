...
public class BlockStickyTorch extends GenericBlockBreakable{
    
	public BlockStickyTorch(int par1)
    {
     ...
     * the item. Args: x, y, z, facing, hitX, hitY, hitZ, block metadata
     */
    public int onBlockPlaced(World par1World, int par2, int par3, int par4, int par5, float par6, float par7, float par8, int par9)
    {
        ...
        return i;
        //par1World.setBlockMetadataWithNotify(par2, par3, par4, i, blockID);
    }
