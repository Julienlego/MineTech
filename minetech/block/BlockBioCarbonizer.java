...
public class BlockBioCarbonizer extends GenericBlockContainer
{
	/**
    ...
    public BlockBioCarbonizer(int i, boolean flag)
    {
    ...
    {
        return MTCore.bioCarbonizerOff.blockID;
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityBioCarbonizer var10 = (TileEntityBioCarbonizer)par1World.getBlockTileEntity(par2, par3, par4);

            if (var10 != null)
            {
            	par5EntityPlayer.openGui(MTCore.instance, 0, par1World, par2, par3, par4);
            }
    ...
    public static void updateFurnaceBlockState(boolean flag, World world, int i, int j, int k)
    {
        ...
        if(flag)
        {
            world.func_94575_c(i, j, k, MTCore.bioCarbonizerOn.blockID);
        } else
        {
            world.func_94575_c(i, j, k, MTCore.bioCarbonizerOff.blockID);
        }
    ...
    public void breakBlock(World world, int i, int j, int k, int x, int y)
    {
        ...
        if(!keepFurnaceInventory){
            TileEntityBioCarbonizer tileentitybiocarbonizer = (TileEntityBioCarbonizer)world.getBlockTileEntity(i, j, k);
            if(tileentitybiocarbonizer != null){

                for(int l = 0; l < tileentitybiocarbonizer.getSizeInventory(); l++){
                    ItemStack itemstack = tileentitybiocarbonizer.getStackInSlot(l);
                    if(itemstack == null){
                        continue;
                    }
