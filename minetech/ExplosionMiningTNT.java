...
public class ExplosionMiningTNT extends Explosion
{
    ...
    private List affectedBlockPositions = new ArrayList();
    private Map field_77288_k = new HashMap();
    private int range = 8;

    public ExplosionMiningTNT(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9)
    {
    ...
    public void doExplosionA()
    {
        ...
        for (i = 0; i < this.range; ++i)
        {
            for (j = 0; j < this.range; ++j)
            {
                ...
                {
                    if (i == 0 || i == this.range - 1 || j == 0 || j == this.range - 1 || k == 0 || k == this.range - 1)
                    {
                        double d3 = (double)((float)i / ((float)this.range - 1.0F) * 2.0F - 1.0F);
                        double d4 = (double)((float)j / ((float)this.range - 1.0F) * 2.0F - 1.0F);
                        double d5 = (double)((float)k / ((float)this.range - 1.0F) * 2.0F - 1.0F);
